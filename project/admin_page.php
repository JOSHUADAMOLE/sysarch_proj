...
<nav class="navbar justify-content-between fs-3 mb-3" style="background-color:#00ff5573;">
  <span class="navbar-brand">Employee List</span>
  <!-- Logout button -->
  ...
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div class="text-body-secondary">
        <span class="h5">All employee</span>
        <br>
        Manage all existing employee or add a new 
      </div>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" style="width:600px;">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="offcanvasExampleLabel">Add new employee</h5>
      ...
      <form method="POST" id="insertForm">
        <div class="row mb-3">
          <div class="col">
            ...
            <input type="text" class="form-control" name="first_name" placeholder="Biboy">
          </div>
          <div class="col">
            <label class="form-label">Last Name</label>
            <input type="text" class="form-control" name="last_name" placeholder="Orange">
          </div>
        </div>
        <div class="mb-3">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditUser" style="width:600px;">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="offcanvasExampleLabel">Edit employee data</h5>
      <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
